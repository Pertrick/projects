...
class MainActivity : AppCompatActivity() {
    ...
    private fun getTopRatedMovies(){
        MoviesRepository.getTopRatedMovie(topRatedMoviesPage, ::onTopRatedMoviesFetched, ::onError)
    }
    ...
    private fun getUpcomingMovies(){
        MoviesRepository.getUpcomingMovie(upcomingMoviePage, ::upcomingMoviesFetched, ::onError)
    }
